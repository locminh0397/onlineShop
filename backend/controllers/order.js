...
sgMail.setApiKey('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');
...
exports.view = (req, res) => {
    //req.order.transaction_id = undefined;
...
exports.create = (req, res) => {
    ...
    order.save((error, data) => {
        ...
        // order.amount
        const emailData = {
            to: 'locvanminh1997@gmail.com', // admin
